...
part 'home_page_article_item.g.dart';


@JsonSerializable()
class HomePageArticleItem extends Object {
  ...
  HomePageArticleItem(this.data,this.errorCode,this.errorMsg,);

  factory HomePageArticleItem.fromJson(Map<String, dynamic> srcJson) => _$HomePageArticleItemFromJson(srcJson);

  Map<String, dynamic> toJson() => _$HomePageArticleItemToJson(this);
